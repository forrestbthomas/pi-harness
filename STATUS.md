...
| **W8 — Dataset versioning + scorecard provenance** (EVAL-3) | In progress — implementation done, PR landing; guarded `datasetVersion` + `provenance` in scorecard |
...
- Open PRs: **W8 PR** (dataset versioning + provenance) · Upstream: pi-subagents **#1077 merged** (`a660ea3`) as per-tool-call timeout, issue **#1076** · Branches: `main` + W8 branch · Remotes: `github` only
