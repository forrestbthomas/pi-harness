...
7. EVAL-16 — harness-change eval gate (**pilot shipped #129**; independent of W5 Part C — orthogonal surfaces; **enforcement pending**: promote on first caught regression; Part C rides v0.12.0's completeness claim)
...
| EVAL-18 | Variance-aware baseline: per-case tolerance from observed variance; ends single-snapshot re-baseline churn | ~1.5 | 0.5 pw |
...
- [ ] OWN-1/SECURITY-line shipped; TAX-1/TAX-2 shipped or parked with recorded decisions (OSS-2 shipped #122).
